              ...
              <div v-swiper:carousel="swiperOption">
                <div class="swiper-wrapper" id="container">
                  <div
                    ...
                    <!-- <img src="~assets/figure/images/jiqiu/pige.png" style="position: absolute; top: 0; left: 0; z-index: 2;"/> -->
                    <div class="color-mask">
                      <span ref="colormask" :id="'pige'+index" :class="'figure figure-pige'+(index+1)" style=""></span>
                    </div>
                    <div class="color-mask">
                      <!-- <canvas id="figure" width="800" height="800"><span class="figure figure-st1"></span>
                       您的浏览器不支持 HTML5 canvas 标签。
                       </canvas> -->
                      <span ref="colormask" :id="'baobian'+index" :class="'figure figure-baobian'+(index+1)" style=""></span>
                      <input class="txtB" :id="'customtext'+index" type="text"  readonly/>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'zhijian'+index" :class="'figure figure-zhijian'+(index+1)" style=""></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'huwan'+index" :class="'figure figure-huwan'+(index+1)" style=""></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'shouwang'+index" :class="'figure figure-shouwang'+(index+1)" style=""></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'shoudai'+index" :class="'figure figure-shoudai'+(index+1)" style=""></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'logo'+index" :class="'figure figure-logo'+(index+1)" style=""></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'logolunkuo'+index" :class="'figure figure-logolunkuo'+(index+1)" style=""></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'shouzhang'+index" :class="'figure figure-shouzhang'+(index+1)" style=""></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'wandai'+index" :class="'figure figure-wandai'+(index+1)" style=""></span>
                    </div>
        ...
        <div class="detail-wrapper">
          ...
          <div class="detail-hd">
            <div class="sidebar-panel">
				<button v-if="buyarr.product_custom != ''" class="savepicbt btn btn-link" @click="savepic($event)">保存成图片</button>
...
import cd from "../plugins/colordata.js"; //保存颜色列表
  ...
  methods: {
	  ...
	  if(this.$refs.colormask.length >=1){
		  for (var i = 0; i < this.$refs.colormask.length; i++) {
		  	this.$refs.colormask[i].style.top = "-212px";
		  }
	  }
	  ...
	  // 第三个版本
	  setColor(itemc,item,indexv,indexcV) { //颜色选择
		...
		for (var i = 0; i < this.colorimgarr.length; i++) {
			let figure = document.getElementById(item.placeN+''+i);
			figure.style.color = itemc.colorV;
		}
		this.buyarr.product_custom = JSON.stringify(this.poparr);

	  },
	  toB(index) {//个性化 文字输入
		this.poparr[2].typearr[index].txtvalue = this.txtValue;
	  	// console.log(this.txtValue)
	      document.getElementsByClassName("txtB")[0].value = this.txtValue;//obj.value;
	  },
    goDetail(item) {
...
<style lang="scss" scoped>
  ...
  .figure-logolunkuo1:before {
    content: "\e740";
  }

  .figure-huwan1:before {
    content: "\e733";
  }

  .figure-huwan2:before {
    content: "\e734";
  }

  .figure-shoudai1:before {
    content: "\e735";
  }
  ...
  .figure-shouwang2:before {
    content: "\e737";
  }

  .figure-wandai1:before {
    content: "\e738";
  }

  .figure-shouzhang1:before {
    content: "\e739";
  }

  .figure-shouzhang2:before {
    content: "\e73a";
  }
  ...
  .figure-shouwang1:before {
    content: "\e73c";
  }

  .figure-baobian1:before {
    content: "\e73d";
  }

  .figure-zhijian1:before {
    content: "\e73e";
  }
