          ...
          <div class="detail-drawing">
            <client-only>
              <div v-swiper:carousel="swiperOption">
                <div class="swiper-wrapper" id="container" style="background:white;">
                  <div
                    ...
                    <!-- 图片堆叠测试 开始 -->
                   <!-- <img src="~assets/figure/images/pige.png" class="duidie" style="background-color: red;"/>
                    <img src="~assets/figure/images/shouwang1.png" class="duidie" style="background-color: blue;"/> -->
                   ...
                   <img :src="item" style="height:auto;"/>
                  </div>
...
<style lang="scss" scoped>
 ...
 .figure-LOGO-1:before {
   content: "\e73a";
 }

 .figure-WRIST_BAND-2:before {
   content: "\e73b";
 }

 .figure-LOGO_OUTLINE-1:before {
   content: "\e73c";
 }

 .figure-HAND_STRAP-1:before {
   content: "\e73d";
 }

 .figure-LEATHER-2:before {
   content: "\e73e";
 }

 .figure-WRIST_STRAP-1:before {
   content: "\e73f";
 }

 .figure-WRIST_BAND-1:before {
   content: "\e740";
 }

 .figure-BINDING-1:before {
   content: "\e741";
 }

 .figure-FINGER_TIPS-1:before {
   content: "\e742";
 }

 .figure-HAND_MESH-2:before {
   content: "\e743";
 }

 .figure-PALM-2:before {
   content: "\e744";
 }

 .figure-PALM-1:before {
   content: "\e745";
 }

 .figure-LEATHER-1:before {
   content: "\e746";
 }

 .figure-HAND_MESH-1:before {
   content: "\e747";
 }
