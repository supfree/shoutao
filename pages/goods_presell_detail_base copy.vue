                ...
                <div class="swiper-wrapper">
                  <div
                   ...
                   <div class="color-mask">
                     <span ref="colormask" :id="'jpkunbang'+index" :class="'figure figure-jpkunbang'+(index+1)"></span>
                   </div>
                   <div class="color-mask">
                     <span ref="colormask" :id="'jpkip'+index" :class="'figure figure-jpkip'+(index+1)"></span>
                     <input class="txtB" :id="'customtext'+index" type="text"  readonly/>
                   </div>
                   <div class="color-mask">
                     <span ref="colormask" :id="'jpxiedai'+index" :class="'figure figure-jpxiedai'+(index+1)"></span>
                   </div>
                   <div class="color-mask">
                     <span ref="colormask" :id="'jppigea'+index" :class="'figure figure-jppigea'+(index+1)"></span>
                   </div>
                   <div class="color-mask">
                     <span ref="colormask" :id="'jppigeb'+index" :class="'figure figure-jppigeb'+(index+1)"></span>
                   </div>
                   <div class="color-mask">
                     <span ref="colormask" :id="'jppigec'+index" :class="'figure figure-jppigec'+(index+1)"></span>
                   </div>
                   <div class="color-mask">
                     <span ref="colormask" :id="'jppiged'+index" :class="'figure figure-jppiged'+(index+1)"></span>
                   </div>
                   <div class="color-mask">
                     <span ref="colormask" :id="'jppigee'+index" :class="'figure figure-jppigee'+(index+1)"></span>
                   </div>
                   <div class="color-mask">
                     <span ref="colormask" :id="'jppigef'+index" :class="'figure figure-jppigef'+(index+1)"></span>
                   </div>
                   <div class="color-mask">
                     <span ref="colormask" :id="'jppigeg'+index" :class="'figure figure-jppigeg'+(index+1)"></span>
                   </div>
                   <div class="color-mask">
                     <span ref="colormask" :id="'jppigeh'+index" :class="'figure figure-jppigeh'+(index+1)"></span>
                   </div>
...
import cd from "../plugins/colordatabase.js"; //保存颜色列表
