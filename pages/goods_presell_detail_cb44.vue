                ...
                <div class="swiper-wrapper">
                  <div
                    ...
                    <div v-for="(item,i) in baseinfo" :key="i">
                      ...
                      <!-- 指孔-->
                      <div v-if="['finger_hold'].includes(item.placeN)&&showbaseindex==i&&tabIndex==0&&index==0">
                          <img :src="`/images/base/finger_hold/${buyarr.productId}/${getBaseValue('指孔')}.png`"  class="thumbnail" />
                      </div>
                      <!-- 本垒小块-->
...
import cd from "../plugins/colordatacb44.js"; //保存颜色列表
...
@import '@/assets/mask/cb44/iconfont.css';
  // 形状和文本叠与底图之上
  .color-mask{
    position: absolute;
    top: 0;
