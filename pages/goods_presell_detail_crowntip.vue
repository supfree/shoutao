              ...
              <div v-swiper:carousel="swiperOption">
                <div class="swiper-wrapper" id="container">
                  <div
                    ...
                    <img :src="item" style="position: absolute; top: 0; left: 0; z-index: 2; opacity: .5;"/>
                   ...
                   <div class="image-mask" :style="'background-image :url('+`/crown_tip/LOGO_STYLE/${poparr[0].typearr[1].values}/${index+1}.png`+')'" v-if="poparr[0].typearr[1].values!=''"/>
...
@import '@/assets/mask/crown_tip/iconfont.css';
  #container{
	  width: 800px;
	  height: 800px;
	  position: relative;
