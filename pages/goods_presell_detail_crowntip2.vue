                ...
                <div class="swiper-wrapper" id="container">
                  <div
                    ...
                    <div class="color-mask">
                      <span ref="colormask" :id="'kunbang'+index" :class="'figure figure-Baseball_Infield_CrownTip_kunbang'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'touguan'+index" :class="'figure figure-Baseball_Infield_CrownTip_touguan'+(index+1)"></span>
                      <input class="txtB" :id="'customtext'+index" type="text"  readonly/>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'benlei'+index" :class="'figure figure-Baseball_Infield_CrownTip_benlei'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'xiedai'+index" :class="'figure figure-Baseball_Infield_CrownTip_xiedai'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'pigea'+index" :class="'figure figure-Baseball_Infield_CrownTip_pigea'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'pigeb'+index" :class="'figure figure-Baseball_Infield_CrownTip_pigeb'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'huibiao'+index" :class="'figure figure-Baseball_Infield_CrownTip_huibiao'+(index+1)"></span>
                    </div>
                    <!-- <div class="color-mask">
                      <span ref="colormask" :id="'huibiaoyangshi'+index" :class="'figure figure-Baseball_Infield_CrownTip_huibiaoyangshi'+(index+1)"></span>
                    </div> -->
                    <div class="color-mask">
                      <span ref="colormask" :id="'zonglv'+index" :class="'figure figure-Baseball_Infield_CrownTip_zonglv'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'fengxian'+index" :class="'figure figure-Baseball_Infield_CrownTip_fengxian'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'wangge'+index" :class="'figure figure-Baseball_Infield_CrownTip_wangge'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'tiebian'+index" :class="'figure figure-Baseball_Infield_CrownTip_tiebian'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'yijianxiaozhi'+index" :class="'figure figure-Baseball_Infield_CrownTip_yijianxiaozhi'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'yijianmuzhi'+index" :class="'figure figure-Baseball_Infield_CrownTip_yijianmuzhi'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'shouwan'+index" :class="'figure figure-Baseball_Infield_CrownTip_shouwan'+(index+1)"></span>
                    </div>
...
import cd from "../plugins/colordatacrowntip.js"; //保存颜色列表
...
<style lang="scss" scoped>
 ...
 .figure-Baseball_Infield_CrownTip_huangguan3:before {
   content: "\e7d1";
 }

 .figure-Baseball_Infield_CrownTip_benlei1:before {
   content: "\e7d2";
 }

 .figure-Baseball_Infield_CrownTip_benlei2:before {
   content: "\e7d3";
 }

 .figure-Baseball_Infield_CrownTip_huibiao2:before {
   content: "\e7d4";
 }

 .figure-Baseball_Infield_CrownTip_huibiao1:before {
   content: "\e7d5";
 }

 .figure-Baseball_Infield_CrownTip_pigea1:before {
   content: "\e7d6";
 }

 .figure-Baseball_Infield_CrownTip_kunbang2:before {
   content: "\e7d7";
 }

 .figure-Baseball_Infield_CrownTip_huangguan4:before {
   content: "\e7d8";
 }

 .figure-Baseball_Infield_CrownTip_kunbang1:before {
   content: "\e7d9";
 }

 .figure-Baseball_Infield_CrownTip_tiebian2:before {
   content: "\e7da";
 }

 .figure-Baseball_Infield_CrownTip_pigeb1:before {
   content: "\e7db";
 }

 .figure-Baseball_Infield_CrownTip_pigeb3:before {
   content: "\e7dc";
 }

 .figure-Baseball_Infield_CrownTip_shouwan1:before {
   content: "\e7dd";
 }

 .figure-Baseball_Infield_CrownTip_kunbang4:before {
   content: "\e7de";
 }

 .figure-Baseball_Infield_CrownTip_pigeb4:before {
   content: "\e7df";
 }

 .figure-Baseball_Infield_CrownTip_xiedai3:before {
   content: "\e7e0";
 }

 .figure-Baseball_Infield_CrownTip_shouwan4:before {
   content: "\e7e1";
 }

 .figure-Baseball_Infield_CrownTip_tiebian4:before {
   content: "\e7e2";
 }

 .figure-Baseball_Infield_CrownTip_xiedai1:before {
   content: "\e7e3";
 }

 .figure-Baseball_Infield_CrownTip_zonglv1:before {
   content: "\e7e4";
 }

 .figure-Baseball_Infield_CrownTip_yijianxiaozhi3:before {
   content: "\e7e5";
 }

 .figure-Baseball_Infield_CrownTip_kunbang3:before {
   content: "\e7e6";
 }

 .figure-Baseball_Infield_CrownTip_wangge1:before {
   content: "\e7e7";
 }

 .figure-Baseball_Infield_CrownTip_pigea3:before {
   content: "\e7e8";
 }

 .figure-Baseball_Infield_CrownTip_huangguan1:before {
   content: "\e7e9";
 }

 .figure-Baseball_Infield_CrownTip_xiedai2:before {
   content: "\e7ea";
 }

 .figure-Baseball_Infield_CrownTip_yijianmuzhi3:before {
   content: "\e7eb";
 }

 .figure-Baseball_Infield_CrownTip_pigea2:before {
   content: "\e7ec";
 }

 .figure-Baseball_Infield_CrownTip_zonglv3:before {
   content: "\e7ed";
 }

 .figure-Baseball_Infield_CrownTip_tiebian1:before {
   content: "\e7ee";
 }

 .figure-Baseball_Infield_CrownTip_tiebian3:before {
   content: "\e7ef";
 }

 .figure-Baseball_Infield_CrownTip_yijianmuzhi2:before {
   content: "\e7f0";
 }

 .figure-Baseball_Infield_CrownTip_zonglv2:before {
   content: "\e7f1";
 }

 .figure-Baseball_Infield_CrownTip_wangge2:before {
   content: "\e7f2";
 }

 .figure-Baseball_Infield_CrownTip_shouwan2:before {
   content: "\e7f3";
 }

 .figure-Baseball_Infield_CrownTip_wangge3:before {
   content: "\e7f4";
 }

 .figure-Baseball_Infield_CrownTip_xiedai4:before {
   content: "\e7f5";
 }

 .figure-Baseball_Infield_CrownTip_yijianxiaozhi4:before {
   content: "\e7f6";
 }
