              ...
              <div v-swiper:carousel="swiperOption">
                <div class="swiper-wrapper" id="container">
                  <div
                    ...
                    <!-- 指垫指套的显示及颜色控制 开始-->
                      <div v-if="getBaseValue('指垫指套')!='无'&&index==0" style="position:relative;z-index:20;">
                        <img :src="`/images/base/pad_hood_placement/${buyarr.productId}/${getBaseValue('指垫指套')}-${getBaseValue('指垫指套位置')}.png`"  class="patchs" v-if="getBaseValue('指垫指套')!='无'"/>
                        <div :style="getPadHoodStyle()" class="patchsvg"/>
                      </div>
                      <!-- 文字-->
                    ...
                    <img :src="item" style="position: absolute; top: 0; left: 0; z-index: 2; opacity: .4;"/>

                    <div class="color-mask">
                      <span ref="colormask" :id="'baobian'+index" :class="'figure figure-Baseball_Infield_EX_10_baobian'+(index+1)"></span>
                      <input class="txtB" :id="'customtext'+index" type="text"  readonly/>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'benlei'+index" :class="'figure figure-Baseball_Infield_EX_10_benlei'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'xiedai'+index" :class="'figure figure-Baseball_Infield_EX_10_xiedai'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'pigea'+index" :class="'figure figure-Baseball_Infield_EX_10_pigea'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'pigeb'+index" :class="'figure figure-Baseball_Infield_EX_10_pigeb'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'pigec'+index" :class="'figure figure-Baseball_Infield_EX_10_pigec'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'huibiao'+index" :class="'figure figure-Baseball_Infield_EX_10_huibiao'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'shouzhang'+index" :class="'figure figure-Baseball_Infield_EX_10_shouzhang'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'fengxian'+index" :class="'figure figure-Baseball_Infield_EX_10_fengxian'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'wangge'+index" :class="'figure figure-Baseball_Infield_EX_10_wangge'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'tiebian'+index" :class="'figure figure-Baseball_Infield_EX_10_tiebian'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'yijianxiaozhi'+index" :class="'figure figure-Baseball_Infield_EX_10_yijianxiaozhi'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'yijianmuzhi'+index" :class="'figure figure-Baseball_Infield_EX_10_yijianmuzhi'+(index+1)"></span>
                    </div>
                    <div class="color-mask">
                      <span ref="colormask" :id="'shouwan'+index" :class="'figure figure-Baseball_Infield_EX_10_shouwan'+(index+1)"></span>
                    </div>
...
import cd from "../plugins/colordataex10.js"; //保存颜色列表
...
export default {
  ...
  methods: {
	  ...
	  btn.disabled = true;
	  btn.innerHTML = "保存中...";
	  let picname = this.storeInfo.store_name;
	  ...
	  // setTimeout(function () {//延时触发生成海报，
		html2Canvas(document.querySelector(".swiper-slide-active"),{
		      width: 800, //截图宽度
		      height: 800, //截图高度
...
<style lang="scss" scoped>
 ...
 .figure-Baseball_Infield_EX_10_baobian2:before {
   content: "\e7a6";
 }

 .figure-Baseball_Infield_EX_10_benlei1:before {
   content: "\e7a7";
 }

 .figure-Baseball_Infield_EX_10_baobian1:before {
   content: "\e7a8";
 }

 .figure-Baseball_Infield_EX_10_benlei2:before {
   content: "\e7a9";
 }

 .figure-Baseball_Infield_EX_10_pigea1:before {
   content: "\e7aa";
 }

 .figure-Baseball_Infield_EX_10_huibiao2:before {
   content: "\e7ab";
 }

 .figure-Baseball_Infield_EX_10_shouwan4:before {
   content: "\e7ac";
 }

 .figure-Baseball_Infield_EX_10_pigea3:before {
   content: "\e7ad";
 }

 .figure-Baseball_Infield_EX_10_pigea2:before {
   content: "\e7ae";
 }

 .figure-Baseball_Infield_EX_10_fengxian3:before {
   content: "\e7af";
 }

 .figure-Baseball_Infield_EX_10_pigec3:before {
   content: "\e7b0";
 }

 .figure-Baseball_Infield_EX_10_tiebian1:before {
   content: "\e7b1";
 }

 .figure-Baseball_Infield_EX_10_baobian4:before {
   content: "\e7b2";
 }

 .figure-Baseball_Infield_EX_10_pigeb3:before {
   content: "\e7b3";
 }

 .figure-Baseball_Infield_EX_10_fengxian1:before {
   content: "\e7b4";
 }

 .figure-Baseball_Infield_EX_10_xiedai2:before {
   content: "\e7b5";
 }

 .figure-Baseball_Infield_EX_10_fengxian4:before {
   content: "\e7b6";
 }

 .figure-Baseball_Infield_EX_10_yijianmuzhi3:before {
   content: "\e7b7";
 }

 .figure-Baseball_Infield_EX_10_pigec1:before {
   content: "\e7b8";
 }

 .figure-Baseball_Infield_EX_10_wangge1:before {
   content: "\e7b9";
 }

 .figure-Baseball_Infield_EX_10_shouzhang2:before {
   content: "\e7ba";
 }

 .figure-Baseball_Infield_EX_10_tiebian3:before {
   content: "\e7bb";
 }

 .figure-Baseball_Infield_EX_10_xiedai1:before {
   content: "\e7bc";
 }

 .figure-Baseball_Infield_EX_10_shouwan2:before {
   content: "\e7bd";
 }

 .figure-Baseball_Infield_EX_10_shouwan1:before {
   content: "\e7be";
 }

 .figure-Baseball_Infield_EX_10_baobian3:before {
   content: "\e7bf";
 }

 .figure-Baseball_Infield_EX_10_shouzhang1:before {
   content: "\e7c0";
 }

 .figure-Baseball_Infield_EX_10_tiebian2:before {
   content: "\e7c1";
 }

 .figure-Baseball_Infield_EX_10_wangge3:before {
   content: "\e7c2";
 }

 .figure-Baseball_Infield_EX_10_pigeb1:before {
   content: "\e7c3";
 }

 .figure-Baseball_Infield_EX_10_yijianmuzhi2:before {
   content: "\e7c4";
 }

 .figure-Baseball_Infield_EX_10_yijianxiaozhi4:before {
   content: "\e7c5";
 }

 .figure-Baseball_Infield_EX_10_pigeb2:before {
   content: "\e7c6";
 }

 .figure-Baseball_Infield_EX_10_wangge2:before {
   content: "\e7c7";
 }

 .figure-Baseball_Infield_EX_10_xiedai3:before {
   content: "\e7c8";
 }

 .figure-Baseball_Infield_EX_10_huibiao1:before {
   content: "\e7c9";
 }

 .figure-Baseball_Infield_EX_10_shouzhang3:before {
   content: "\e7ca";
 }

 .figure-Baseball_Infield_EX_10_xiedai4:before {
   content: "\e7cb";
 }

 .figure-Baseball_Infield_EX_10_yijianxiaozhi3:before {
   content: "\e7cc";
 }

 .figure-Baseball_Infield_EX_10_tiebian4:before {
   content: "\e7cd";
 }

 .figure-Baseball_Infield_EX_10_fengxian2:before {
   content: "\e7ce";
 }

 .figure-Baseball_Infield_EX_10_pigeb4:before {
   content: "\e7cf";
 }

 .figure-Baseball_Infield_EX_10_pigec4:before {
   content: "\e7d0";
 }
  ...
  .detail-wrapper {
    ...
    .colors{
      ...
      a{
        ...
        &:hover span{
          // box-shadow: none;
          box-shadow: rgba(0, 0, 0, 0.5) 0 0 1px 0px;
        }
      }
      a.on::before{
        position: absolute;
