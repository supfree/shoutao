                  ...
                  <div
                    ...
                    <div v-for="(item,i) in baseinfo" :key="i">
                      ...
                      <div style="position:relative;z-index:20;" v-if="tabIndex==2&&index==1">
                          <div class="logo-svg" :style="`top:480px;left:280px;position:absolute;width:200px;height:185px;background-size:cover;background-image:url(/images/base/thumb_logo/${buyarr.productId}/${getBaseValue('拇指圈LOGO').replace(' ','%20')}-1.png)`"/>
                      </div>
                      <!-- 手掌烫印 logo-->
                      <div style="position:relative;z-index:20;">
