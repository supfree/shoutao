module.exports={
    ...
    {title:'定制数字',showtype:"text",placeN:'palm_sign_text',style:[undefined,{top:-30,left:360,size:90,transform:0}],activeI:'null',colorlist:[]},
		...
		{title:'拇指文字',showtype:"text",placeN:'thumb_text',style:[{top:-420,left:270,size:30,transform:275}],activeI:'null',colorlist:[
    ]},
    {title:"小指文字",showtype:"text",placeN:'pinky_text',style:[{top:240,left:-130,size:35,transform:80}],activeI:'null',colorlist:[
    ]},
