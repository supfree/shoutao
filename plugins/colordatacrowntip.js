module.exports={
    ...
    {title:'头冠',placeN:'CROWN_COLOR',activeI:'null',colorlist:[
    ]},
    ...
    {title:"食指文字",showtype:"text",placeN:'index_text',activeI:'null',style:[{top:-260,left:480,size:30,transform:105}],colorlist:[
      {colorV:'#5C4032',colorN:'CC28'},
      {colorV:'#772F09',colorN:'PA28'},
      {colorV:'#817F42',colorN:'PA42'},
      {colorV:'#D23745',colorN:'PT23'},
